global.gContractAddress = '0xd0418fb22e6d511339ABCa895d94C867EDFae05f';
...
export var AddUser = function(userName, userAddress, callback) {
  ...
  // var data = '0x965ada2d' + '40'.padStart(64, '0') + userAddress.substr(2).padStart(64, '0') + '5'.padStart(64, '0') + toStippedHex(userName).padEnd(64, '0');
  // var opt =  {
  //     from: chain3js.mc.accounts[0],
  //     to: gContractAddress,
  //     gas: 5000000,
  ...
  //     data: data
  //   };
  // console.log('MoacConnect.AddUser', userName, userAddress, data, opt);
  // chain3js.mc.sendTransaction(
  //   opt,
  //   function (e,c) {
  //     console.log(e, c);
